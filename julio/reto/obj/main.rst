...
Hexadecimal [16-Bits]
                              ...
                              7 .globl cpct_drawCharM1_asm
                              8 .globl cpct_scanKeyboard_asm
                              9 .globl cpct_isKeyPressed_asm
                             10 .globl cpct_isAnyKeyPressed_asm
                             11 
   4121                      12 _main::
                             13    ;; Disable firmware to prevent it from interfering with string drawing
   4121 CD 3A 40      [17]   14    call cpct_disableFirmware_asm
                             15 
   4124 16 00         [ 7]   16    ld    d, #0        
   4126 1E 01         [ 7]   17    ld    e, #1         
                             18    ;; Set draw char colours
   4128 CD 4B 40      [17]   19    call cpct_setDrawCharM1_asm   
                             20 
   412B 1E 48         [ 7]   21    ld    e, #"H"
   412D 21 00 C0      [10]   22    ld   hl, #0XC000
                             23    ;; Draw char in HL
   4130 CD 0C 40      [17]   24    call cpct_drawCharM1_asm
                             25 
   4133 1E 49         [ 7]   26    ld    e, #"I"
   4135 21 02 C0      [10]   27    ld   hl, #0XC002
                             28    ;; Draw char in HL
   4138 CD 0C 40      [17]   29    call cpct_drawCharM1_asm
                             30 
                             31 ;; Comprobar si se ha pulsado cualquier tecla
   413B                      32 loopCualquierLetra:
   413B CD 9C 40      [17]   33    call cpct_scanKeyboard_asm
                             34    ;; Se pulsa la letra H
   413E 21 05 10      [10]   35    ld   hl, #Key_H 
   4141 CD 00 40      [17]   36    call cpct_isKeyPressed_asm
   4144 20 07         [12]   37    jr nz, pintarCyan
                             38    ;; Se pulsa cualquier otra letra
   4146 CD 2D 40      [17]   39    call cpct_isAnyKeyPressed_asm
   4149 20 13         [12]   40    jr nz, pintarGuion
                             41 
   414B 18 EE         [12]   42    jr loopCualquierLetra
                             43 
                             44 ;; Pintar en cyan
   414D                      45 pintarCyan:
   414D 16 00         [ 7]   46    ld    d, #0        
   414F 1E 02         [ 7]   47    ld    e, #2         
                             48    ;; Set draw char colours
   4151 CD 4B 40      [17]   49    call cpct_setDrawCharM1_asm   
   4154 1E 48         [ 7]   50    ld    e, #"H"
   4156 21 00 C0      [10]   51    ld   hl, #0XC000
                             52    ;; Draw char in HL
   4159 CD 0C 40      [17]   53    call cpct_drawCharM1_asm
   415C 18 11         [12]   54    jr loopEspera
                             55 
   415E                      56 pintarGuion:
...
Hexadecimal [16-Bits]
   ...
   415E 16 00         [ 7]   57    ld    d, #0        
   4160 1E 03         [ 7]   58    ld    e, #3         
                             59    ;; Set draw char colours
   4162 CD 4B 40      [17]   60    call cpct_setDrawCharM1_asm   
   4165 1E 2D         [ 7]   61    ld    e, #"-"
   4167 21 00 C0      [10]   62    ld   hl, #0XC000
                             63    ;; Draw char in HL
   416A CD 0C 40      [17]   64    call cpct_drawCharM1_asm
                             65 
   416D 3E 3C         [ 7]   66 ld a, #60
   416F                      67 loopEspera:
   416F 76            [ 4]   68    halt
   4170 3D            [ 4]   69    dec a
   4171 20 FC         [12]   70    jr nz, loopEspera
                             71 
   4173                      72 loopCualquierLetra2:
   4173 CD 9C 40      [17]   73    call cpct_scanKeyboard_asm
                             74    ;; Se pulsa la letra I
   4176 21 04 08      [10]   75    ld   hl, #Key_I 
   4179 CD 00 40      [17]   76    call cpct_isKeyPressed_asm
   417C 20 07         [12]   77    jr nz, pintarCyan2
                             78    ;; Se pulsa cualquier otra letra
   417E CD 2D 40      [17]   79    call cpct_isAnyKeyPressed_asm
   4181 20 13         [12]   80    jr nz, pintarGuion2
                             81 
   4183 18 EE         [12]   82    jr loopCualquierLetra2
                             83 
   4185                      84 pintarCyan2:
   4185 16 00         [ 7]   85    ld    d, #0        
   4187 1E 02         [ 7]   86    ld    e, #2         
                             87    ;; Set draw char colours
   4189 CD 4B 40      [17]   88    call cpct_setDrawCharM1_asm   
   418C 1E 49         [ 7]   89    ld    e, #"I"
   418E 21 02 C0      [10]   90    ld   hl, #0XC002
                             91    ;; Draw char in HL
   4191 CD 0C 40      [17]   92    call cpct_drawCharM1_asm
   4194 18 0F         [12]   93    jr loop2
                             94 
   4196                      95 pintarGuion2:
   4196 16 00         [ 7]   96    ld    d, #0        
   4198 1E 03         [ 7]   97    ld    e, #3         
                             98    ;; Set draw char colours
   419A CD 4B 40      [17]   99    call cpct_setDrawCharM1_asm   
   419D 1E 2D         [ 7]  100    ld    e, #"-"
   419F 21 02 C0      [10]  101    ld   hl, #0XC002
                            102    ;; Draw char in HL
   41A2 CD 0C 40      [17]  103    call cpct_drawCharM1_asm
                            104 
   41A5                     105 loop2:
   41A5 18 FE         [12]  106    jr loop2
