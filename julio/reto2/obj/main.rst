...
Hexadecimal [16-Bits]
                              ...
                              5 
                              6 ;;
                              7 ;; Plantilla de datos iniciales de un copo
                              8 ;;
   4000                       9 copos_actuales: 
   4000 00                   10    .db 0
                             11 
   4001                      12 plantilla_copo:
   4001 19 00                13    .db 25,    0   ;; ( X,   Y  ) Coordenadas de pantalla
   4003 01 F0                14    .db  1, 0xF0   ;; (VY, Color) Velocidad en Y, Color del copo
                     0004    15 copo_size = .-plantilla_copo
                     000A    16 max_copos = 10
                             17 
                     0028    18 tam_array = max_copos*copo_size
                             19 
   4005 BE EF                20 .db 0xBE, 0xEF
   4007                      21 copos_array::
   4007                      22     .ds tam_array
   402F BE EF                23 .db 0xBE, 0xEF
                             24 
                             25 ;;@@@@@@@@@@@@@@
                             26 
                             27 ;;---------------------------------------------------------------
                             ...
                             29 ;;---------------------------------------------------------------
   4031                      30 _main::
   4031 CD 67 40      [17]   31    call init_copos_array
                             32 
   4034 CD 45 40      [17]   33    call new_copo
   4037 CD 45 40      [17]   34    call new_copo
   403A CD 45 40      [17]   35    call new_copo
   403D CD 45 40      [17]   36    call new_copo
   4040 CD 45 40      [17]   37    call new_copo
                             38 
   4043                      39 _loop:
                             40 
   4043 18 FE         [12]   41    jr _loop
                             42 
                             43 ;;;;;;;;;;;;;;;;;;;;;
                             44 ;;      COPOS      ;;
                             45 ;;;;;;;;;;;;;;;;;;;;;
                             46 ;;
   4045                      47 new_copo:
   4045 2A 00 40      [16]   48    ld   hl, (copos_actuales)
   4048 CD 53 40      [17]   49    call init_copo
                             50 
                             51    ;; Sumar uno a copos
   404B 3A 00 40      [13]   52    ld    a, (copos_actuales)
   404E 3C            [ 4]   53    inc   a
   404F 32 00 40      [13]   54    ld    (copos_actuales), a
                             55 
   4052 C9            [10]   56    ret
...
Hexadecimal [16-Bits]
                             ...
                             57 ;;
                             58 ;; Input: HL --> index of new copo  
                             59 ;;
   4053                      60 init_copo:
   4053 29            [11]   61    add   hl, hl
   4054 29            [11]   62    add   hl, hl
   4055 11 07 40      [10]   63    ld    de, #copos_array
   4058 19            [11]   64    add   hl, de
   4059 EB            [ 4]   65    ex    de, hl
   405A CD 5E 40      [17]   66    call create_copo
                             67 
   405D C9            [10]   68    ret
                             69 ;;
                             70 ;; Input: DE
                             71 ;;
   405E                      72 create_copo:
   405E 21 01 40      [10]   73    ld    hl, #plantilla_copo
   4061 01 04 00      [10]   74    ld    bc, #copo_size
   4064 ED B0         [21]   75    ldir
                             76 
   4066 C9            [10]   77    ret
                             78 
   4067                      79 init_copos_array:
   4067 21 07 40      [10]   80    ld    hl, #copos_array
   406A 36 00         [10]   81    ld  (hl), #0x00
   406C 11 07 40      [10]   82    ld    de, #copos_array
   406F 01 28 00      [10]   83    ld    bc, #tam_array
   4072 ED B0         [21]   84    ldir
                             85 
   4074 C9            [10]   86    ret
