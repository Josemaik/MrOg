...
Hexadecimal [16-Bits]
                             ...
                             10 .area _CODE
                             11 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             12 ;; UPDATE PAIR ENTITIES
                             13 ;;  updates the collision of a given entity
                             14 ;; IN -> DE: left entity
                             15 ;;       BC: rght entity
   4713                      16 sys_collisions_update_entities::
                             17     ; ld a, #0x00
                             18     ; ld (0xC000),a
                             19     ;; check if both entities can collide
                             20     ;; check if entity of right can collid another entity
                             21     ;; e(r)->collides_against
   4713 21 10 00      [10]   22     ld hl, #COLLIDES_AGAINST
   4716 09            [11]   23     add hl, bc
   4717 7E            [ 7]   24     ld a, (hl)
                             25     ;; e(l)->type
   4718 21 00 00      [10]   26     ld hl, #TYPE
   471B 19            [11]   27     add hl, de
   471C A6            [ 7]   28     and (hl)
                             29     ;; check if can collide( e(r)->collides_against && e(l)->type == 0 )
   471D BE            [ 7]   30     cp (hl)
   471E 28 0F         [12]   31     jr z, check_collision_between_entities
                             32 
   4720 21 10 00      [10]   33     ld hl, #COLLIDES_AGAINST
   4723 19            [11]   34     add hl, de
   4724 7E            [ 7]   35     ld a, (hl)
                             36 
   4725 21 00 00      [10]   37     ld hl, #TYPE
   4728 09            [11]   38     add hl, bc
   4729 A6            [ 7]   39     and (hl)
                             40 
   472A BE            [ 7]   41     cp (hl)
   472B 28 02         [12]   42     jr z, check_collision_between_entities
   472D 18 32         [12]   43         jr dont_have_collision_between_entities
   472F                      44     check_collision_between_entities:
...
Hexadecimal [16-Bits]
                             ...
                             86         ;; y(l)
   472F 21 03 00      [10]   87         ld hl, #Y
   4732 19            [11]   88         add hl, de
   4733 7E            [ 7]   89         ld a, (hl)
                             90         ;; height(l)
   4734 21 05 00      [10]   91         ld hl,#HEIGHT
   4737 19            [11]   92         add hl,de
   4738 86            [ 7]   93         add (hl)
                             94         ;; y(r)
   4739 21 03 00      [10]   95         ld hl, #Y
   473C 09            [11]   96         add hl, bc
   473D 96            [ 7]   97         sub (hl)
                             98         ; ;; if carry is 1 -> no collision
   473E 38 1C         [12]   99         jr c, no_collision
   4740 18 13         [12]  100             jr collision
                            101         ; ;; C < D
                            102         ; ;; if(y(r) + height(r) < y(l)) no collision
                            103         ; ;; if(y(r) + height(r) - y(l) < 0)no collision
                            104         ; ;; y(l)
   4742 21 03 00      [10]  105         ld hl, #Y
   4745 09            [11]  106         add hl, bc
   4746 7E            [ 7]  107         ld a, (hl)
                            108         ;; height(l)
   4747 21 05 00      [10]  109         ld hl,#HEIGHT
   474A 09            [11]  110         add hl,bc
   474B 86            [ 7]  111         add (hl)
                            112         ;; y(r)
   474C 21 03 00      [10]  113         ld hl, #Y
   474F 19            [11]  114         add hl, de
   4750 96            [ 7]  115         sub (hl)
...
Hexadecimal [16-Bits]
                            ...
                            116         
   4751 38 09         [12]  117         jr c, no_collision
   4753 18 00         [12]  118             jr collision
                            119 
                            120 
                            121         ;; si hay colision
   4755                     122         collision:
   4755 3E FF         [ 7]  123             ld a, #0xFF
   4757 32 00 C0      [13]  124             ld (0xC000), a
   475A 18 05         [12]  125             jr dont_have_collision_between_entities
                            126             ; call man_game_entity_destroy
                            127         ;; there is collision, check entity types and react
   475C                     128         no_collision:
   475C 3E 00         [ 7]  129             ld a, #0x00
   475E 32 00 C0      [13]  130             ld (0xC000),a
   4761                     131     dont_have_collision_between_entities:
   4761 C9            [10]  132 ret
   4762                     133 _sys_collision_update::
   4762 01 13 47      [10]  134     ld bc, #sys_collisions_update_entities
   4765 21 20 00      [10]  135     ld hl, #E_CMP_COLLIDER
   4768 CD 0C 4A      [17]  136     call _man_entity_for_all_pairs_matching_while1
   476B C9            [10]  137 ret
