...
Hexadecimal [16-Bits]
                             ...
                             15 ;;       BC: rght entity
   4C37                      16 sys_collisions_update_entities::
                             17     ; ld a, #0x00
                             18     ; ld (0xC000),a
                             19     ;; check if both entities can collide
                             20     ;; check if entity of right can collid another entity
                             21     ;; e(r)->collides_against
   4C37 21 10 00      [10]   22     ld hl, #COLLIDES_AGAINST
   4C3A 09            [11]   23     add hl, bc
   4C3B 7E            [ 7]   24     ld a, (hl)
                             25     ;; e(l)->type
   4C3C 21 00 00      [10]   26     ld hl, #TYPE
   4C3F 19            [11]   27     add hl, de
   4C40 A6            [ 7]   28     and (hl)
                             29     ;; check if can collide( e(r)->collides_against && e(l)->type == 0 )
   4C41 BE            [ 7]   30     cp (hl)
   4C42 28 0F         [12]   31     jr z, check_collision_between_entities
                             32 
   4C44 21 10 00      [10]   33     ld hl, #COLLIDES_AGAINST
   4C47 19            [11]   34     add hl, de
   4C48 7E            [ 7]   35     ld a, (hl)
                             36 
   4C49 21 00 00      [10]   37     ld hl, #TYPE
   4C4C 09            [11]   38     add hl, bc
   4C4D A6            [ 7]   39     and (hl)
                             40 
   4C4E BE            [ 7]   41     cp (hl)
   4C4F 28 02         [12]   42     jr z, check_collision_between_entities
   4C51 18 32         [12]   43         jr dont_have_collision_between_entities
   4C53                      44     check_collision_between_entities:
...
Hexadecimal [16-Bits]
                             ...
                             86         ;; y(l)
   4C53 21 03 00      [10]   87         ld hl, #Y
   4C56 19            [11]   88         add hl, de
   4C57 7E            [ 7]   89         ld a, (hl)
                             90         ;; height(l)
   4C58 21 05 00      [10]   91         ld hl,#HEIGHT
   4C5B 19            [11]   92         add hl,de
   4C5C 86            [ 7]   93         add (hl)
                             94         ;; y(r)
   4C5D 21 03 00      [10]   95         ld hl, #Y
   4C60 09            [11]   96         add hl, bc
   4C61 96            [ 7]   97         sub (hl)
                             98         ; ;; if carry is 1 -> no collision
   4C62 38 1C         [12]   99         jr c, no_collision
   4C64 18 13         [12]  100             jr collision
                            101         ; ;; C < D
                            102         ; ;; if(y(r) + height(r) < y(l)) no collision
                            103         ; ;; if(y(r) + height(r) - y(l) < 0)no collision
                            104         ; ;; y(l)
   4C66 21 03 00      [10]  105         ld hl, #Y
   4C69 09            [11]  106         add hl, bc
   4C6A 7E            [ 7]  107         ld a, (hl)
                            108         ;; height(l)
   4C6B 21 05 00      [10]  109         ld hl,#HEIGHT
   4C6E 09            [11]  110         add hl,bc
   4C6F 86            [ 7]  111         add (hl)
                            112         ;; y(r)
   4C70 21 03 00      [10]  113         ld hl, #Y
   4C73 19            [11]  114         add hl, de
   4C74 96            [ 7]  115         sub (hl)
...
Hexadecimal [16-Bits]
                            ...
                            116         
   4C75 38 09         [12]  117         jr c, no_collision
   4C77 18 00         [12]  118             jr collision
                            119 
                            120 
                            121         ;; si hay colision
   4C79                     122         collision:
   4C79 3E FF         [ 7]  123             ld a, #0xFF
   4C7B 32 00 C0      [13]  124             ld (0xC000), a
   4C7E 18 05         [12]  125             jr dont_have_collision_between_entities
                            126             ; call man_game_entity_destroy
                            127         ;; there is collision, check entity types and react
   4C80                     128         no_collision:
   4C80 3E 00         [ 7]  129             ld a, #0x00
   4C82 32 00 C0      [13]  130             ld (0xC000),a
   4C85                     131     dont_have_collision_between_entities:
   4C85 C9            [10]  132 ret
   4C86                     133 _sys_collision_update::
   4C86 01 37 4C      [10]  134     ld bc, #sys_collisions_update_entities
   4C89 21 20 00      [10]  135     ld hl, #E_CMP_COLLIDER
   4C8C CD 49 4F      [17]  136     call _man_entity_for_all_pairs_matching_while1
   4C8F C9            [10]  137 ret
