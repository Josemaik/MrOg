...
Hexadecimal [16-Bits]
                              ...
                              6 
                              7 
   4F4A                       8     m_entities::    ;;entities
   4F4A                       9         .ds #TOTAL_SPACE_4_ENTITIES
   4F5E                      10     m_zero_byte_end_entities:      ;;zero-byte to signal invalid entities
   4F5E                      11         .ds 1
   4F5F                      12     m_next_free_entity::    ;; pointer to next free entity
   4F5F                      13         .ds 2
   4F61                      14     m_reserved_entites:: ;;number of reserved entities
   4F61                      15         .ds 1   ;;u8
                             16 
                             17 .area _CODE
                             18 ;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             23 ;; GENERAL INIT ;;
                             24 ;;;;;;;;;;;;;;;;;;
   4ADE                      25 _man_entity_init::
                             26 
                             27     ;; save the first element of entities
                             28     ;;m_next_free_entity = m_entities;
   4ADE 21 4A 4F      [10]   29         ld      hl, #m_entities
   4AE1 22 5F 4F      [16]   30         ld      (m_next_free_entity),  hl
                             31 
   ...
   4AE4 5D            [ 4]   36         ld      e, l
   4AE5 54            [ 4]   37         ld      d, h
   4AE6 3E 00         [ 7]   38         ld      a, #0
   4AE8 01 14 00      [10]   39         ld      bc, #TOTAL_SPACE_4_ENTITIES
   4AEB CD 2C 4E      [17]   40         call    cpct_memset_asm
                             41     
                             42     ;; load a 0 in reserved_entities
   4AEE 3E 00         [ 7]   43         ld      a, #0
   4AF0 32 61 4F      [13]   44         ld      (m_reserved_entites), a
                             45     
                             46     ;; load invalid type in _m_zero_byte_end_entities
   4AF3 3E 00         [ 7]   47         ld      a, #E_TYPE_INVALID
   4AF5 32 5E 4F      [13]   48         ld      (m_zero_byte_end_entities), a
                             49 
   4AF8 C9            [10]   50     ret
                             51 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             52 
...
Hexadecimal [16-Bits]
   ...
   4AF9 ED 5B 5F 4F   [20]   60         ld      de, (m_next_free_entity)
                             61 
                             62     ;; set type on default
   4AFD 21 00 00      [10]   63         ld      hl, #TYPE
   4B00 19            [11]   64         add     hl, de
   4B01 36 02         [10]   65         ld      (hl), #E_TYPE_DEFAULT
                             66     ;; Set cmp to default
   4B03 21 01 00      [10]   67         ld hl, #CMPs
   4B06 19            [11]   68         add hl,de
   4B07 36 7F         [10]   69         ld (hl), #E_CMP_DEFAULT
                             70 
                             71     ;; update the pointer to SPACE_4_ONE_ENTITY positons furthers (the next entity)
   4B09 21 14 00      [10]   72         ld      hl, #SPACE_4_ONE_ENTITY
   4B0C 19            [11]   73         add     hl, de
   4B0D 22 5F 4F      [16]   74         ld      (m_next_free_entity), hl
                             75 
                             76     ;; increase reserved entities
   4B10 3A 61 4F      [13]   77         ld      a, (m_reserved_entites)
   4B13 3C            [ 4]   78         inc     a
   4B14 32 61 4F      [13]   79         ld      (m_reserved_entites), a
                             80 
   4B17 C9            [10]   81     ret
                             82 
                             83 ;;;;;;;;;;;;;;;;;;;;;;;
   ...
   4B18 D5            [11]   95     push de
                             96     ;; create entity
   4B19 CD F9 4A      [17]   97     call _man_entity_create
                             98     ;; retrieve de entity to clone in hl
   4B1C E1            [10]   99     pop hl
                            100     ;; size in bc
   4B1D 01 14 00      [10]  101     ld      bc, #SPACE_4_ONE_ENTITY
                            102     ;; save pinter to new entity
   4B20 D5            [11]  103     push de
                            104     ;; copy entity to clone in new entity
   4B21 CD 34 4E      [17]  105     call cpct_memcpy_asm
                            106     ;; retrieve pointer to new entity
   4B24 D1            [10]  107     pop de
   4B25 C9            [10]  108 ret
                            109 
                            110 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
   ...
   4B26                     115 _man_entity_set_for_destruction::
                            116 
                            117     ;; go to entity -> type
   4B26 21 00 00      [10]  118         ld      hl, #TYPE
   4B29 19            [11]  119         add     hl, de
                            120     
                            121     ;; save entity->type in a
   4B2A 7E            [ 7]  122         ld      a, (hl)
                            123     
                            124     ;; set entity for destruction
   4B2B F6 80         [ 7]  125         or      #E_TYPE_DEAD
   4B2D 77            [ 7]  126         ld      (hl), a
                            127 
   4B2E C9            [10]  128     ret
                            129 
                            130 
   ...
   4B2F 2A 5F 4F      [16]  145         ld      hl, (m_next_free_entity)
   4B32 01 14 00      [10]  146         ld      bc, #SPACE_4_ONE_ENTITY
   4B35 B7            [ 4]  147         or      a
   4B36 ED 42         [15]  148         sbc     hl, bc
                            149     
                            150     ;; save the last entity
   4B38 E5            [11]  151         push    hl
                            152 
                            153     ;; last == de
                            154     ;;conditional to copy
   4B39 B7            [ 4]  155         or      a
   4B3A ED 52         [15]  156         sbc     hl, de
   4B3C 28 05         [12]  157         jr      z, man_if_not_copy  
                            158 
                            159     ;; retrieve and save last entity 
   4B3E E1            [10]  160         pop     hl
   4B3F E5            [11]  161         push    hl
                            162 
                            163     ;; call the function (last != de)
   4B40 CD 34 4E      [17]  164         call    cpct_memcpy_asm
                            165     
   4B43                     166     man_if_not_copy:
                            167     ;; retrieve last entity 
   4B43 E1            [10]  168         pop     hl
                            169 
...
Hexadecimal [16-Bits]
   ...
   4B44 36 00         [10]  171         ld      (hl), #E_TYPE_INVALID
                            172 
                            173     ;; set _m_next_free_entity to last
   4B46 22 5F 4F      [16]  174         ld      (m_next_free_entity), hl
                            175 
                            176     ;; decrease reserved entities
   4B49 3A 61 4F      [13]  177         ld      a, (m_reserved_entites)
   4B4C 3D            [ 4]  178         dec     a
   4B4D 32 61 4F      [13]  179         ld      (m_reserved_entites), a
                            180 
   4B50 C9            [10]  181     ret
                            182 
                            183 ;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            187 ;;
   4B51                     188 _man_entity_for_all::
                            189 
                            190     ;; stack opened
   4B51 DD 21 FE FF   [14]  191         ld      ix, #-2
   4B55 DD 39         [15]  192         add     ix, sp
   4B57 DD F9         [10]  193         ld      sp, ix
                            194 
                            195     ;; save the function to call
   4B59 DD 71 00      [19]  196         ld      0(ix), c
   4B5C DD 70 01      [19]  197         ld      1(ix), b
                            198 
                            199     ;; load first position of an entity
   4B5F 11 4A 4F      [10]  200         ld      de, #m_entities     
   4B62 D5            [11]  201         push de
                            202     ;; while
   4B63                     203     man_init_for:
                            204         ;; if
                            205             ;; go to type of entity
   4B63 21 00 00      [10]  206                 ld      hl, #TYPE
   4B66 19            [11]  207                 add     hl, de             
                            208 
                            209             ;; save in a the type and compare with #E_TYPE_INVALID
   4B67 7E            [ 7]  210                 ld      a, (hl)
   4B68 FE 00         [ 7]  211                 cp      #E_TYPE_INVALID    
   4B6A 28 16         [12]  212                 jr      z, man_end_for     
                            213 
                            214                 ; push de
                            215             ;; save returning point
   4B6C 21 78 4B      [10]  216                 ld      hl, #_return_hear
   4B6F E5            [11]  217                 push    hl
                            218 
                            219             ;; call function
   4B70 DD 4E 00      [19]  220                 ld      c, 0(ix)
   4B73 DD 46 01      [19]  221                 ld      b, 1(ix)
   4B76 C5            [11]  222                 push    bc                  
   4B77 C9            [10]  223                 ret                         
                            224 
...
Hexadecimal [16-Bits]
   ...
   4B78                     225             _return_hear:
   4B78 D1            [10]  226                     pop de
   4B79 21 14 00      [10]  227                     ld      hl, #SPACE_4_ONE_ENTITY
   4B7C 19            [11]  228                     add     hl, de
                            229 
                            230                 ;; HL<=>DE
   4B7D 5D            [ 4]  231                     ld      e, l              
   4B7E 54            [ 4]  232                     ld      d, h
                            233 
   4B7F D5            [11]  234                     push de
                            235 
   4B80 18 E1         [12]  236                     jr      man_init_for       
                            237 
   4B82                     238     man_end_for:
                            239         ;; close stack
   4B82 DD 21 02 00   [14]  240             ld      ix, #2
   4B86 DD 39         [15]  241             add     ix, sp
   4B88 DD F9         [10]  242             ld      sp, ix
                            243     
   4B8A C9            [10]  244     ret
                            245 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            249 ;;
   4B8B                     250     _man_entity_for_all_matching::
                            251 
                            252     ;; stack opened
   4B8B DD 21 FA FF   [14]  253         ld      ix, #-6
   4B8F DD 39         [15]  254         add     ix, sp
   4B91 DD F9         [10]  255         ld      sp, ix
                            256 
                            257     ;; save the function to call
   4B93 DD 71 00      [19]  258         ld      0(ix), c
   4B96 DD 70 01      [19]  259         ld      1(ix), b
                            260     ;; save the condition to call function
   4B99 DD 75 02      [19]  261         ld      2(ix), l
   4B9C DD 74 03      [19]  262         ld      3(ix), h
                            263 
                            264     ;; load first position of an entity
   4B9F 11 4A 4F      [10]  265         ld      de, #m_entities     
   4BA2 D5            [11]  266         push de
                            267     ;; while
   4BA3                     268     man_init_for_match:
   4BA3 D1            [10]  269     pop de
                            270         ;; if
                            271             ;; go to type of entity
   4BA4 21 00 00      [10]  272                 ld      hl, #TYPE
   4BA7 19            [11]  273                 add     hl, de             
                            274 
                            275             ;; save in a the type and compare with #E_TYPE_INVALID
   4BA8 7E            [ 7]  276                 ld      a, (hl)
   4BA9 FE 00         [ 7]  277                 cp      #E_TYPE_INVALID    
   4BAB 28 26         [12]  278                 jr      z, man_end_for_match     
                            279 
...
Hexadecimal [16-Bits]
   ...
   4BAD D5            [11]  280                 push de
   4BAE 21 01 00      [10]  281                 ld hl, #CMPs
   4BB1 19            [11]  282                 add hl,de
   4BB2 7E            [ 7]  283                 ld a, (hl)
   4BB3 DD 6E 02      [19]  284                 ld l, 2(ix)
   4BB6 DD 66 03      [19]  285                 ld h, 3(ix)
   4BB9 A5            [ 4]  286                 and l
   4BBA BD            [ 4]  287                 cp  l
   4BBB 20 0C         [12]  288                 jr nz, _return_hear_match
                            289 
                            290             ;; save returning point
   4BBD 21 C9 4B      [10]  291                 ld      hl, #_return_hear_match
   4BC0 E5            [11]  292                 push    hl
                            293 
                            294             ;; call function
   4BC1 DD 4E 00      [19]  295                 ld      c, 0(ix)
   4BC4 DD 46 01      [19]  296                 ld      b, 1(ix)
   4BC7 C5            [11]  297                 push    bc                  
   4BC8 C9            [10]  298                 ret                         
                            299             ;; if entity is not movable continue here
   4BC9                     300             _return_hear_match:
   4BC9 D1            [10]  301                     pop de
   4BCA 21 14 00      [10]  302                     ld      hl, #SPACE_4_ONE_ENTITY
   4BCD 19            [11]  303                     add     hl, de
                            304 
                            305                 ;; HL<=>DE
   4BCE 5D            [ 4]  306                     ld      e, l              
   4BCF 54            [ 4]  307                     ld      d, h
                            308 
   4BD0 D5            [11]  309                     push de
                            310 
   4BD1 18 D0         [12]  311                     jr      man_init_for_match       
                            312 
   4BD3                     313     man_end_for_match:
                            314         ;; close stack
   4BD3 DD 21 06 00   [14]  315             ld      ix, #6
   4BD7 DD 39         [15]  316             add     ix, sp
   4BD9 DD F9         [10]  317             ld      sp, ix
                            318     
   4BDB C9            [10]  319     ret
                            320 
                            321 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            325 ;;
   4BDC                     326     _man_entity_for_all_pairs_matching_while1::
                            327 
                            328     ;; stack opened
   4BDC DD 21 FC FF   [14]  329         ld      ix, #-4
   4BE0 DD 39         [15]  330         add     ix, sp
   4BE2 DD F9         [10]  331         ld      sp, ix
                            332 
                            333     ;; save the function to call
   4BE4 DD 71 00      [19]  334         ld      0(ix), c
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 103.
Hexadecimal [16-Bits]



   4BE7 DD 70 01      [19]  335         ld      1(ix), b
                            336     ;; save the condition to call function
   4BEA DD 75 02      [19]  337         ld      2(ix), l
   4BED DD 74 03      [19]  338         ld      3(ix), h
                            339 
                            340     ;; load first position of an entity
   4BF0 11 4A 4F      [10]  341         ld      de, #m_entities     
   4BF3 D5            [11]  342         push de
                            343     ;; while
   4BF4                     344     man_init_while_l:
   4BF4 D1            [10]  345             pop de
                            346             ;; if
                            347             ;; go to type of entity
   4BF5 21 00 00      [10]  348                     ld      hl, #TYPE
   4BF8 19            [11]  349                     add     hl, de             
                            350 
                            351             ;; save in a the type and compare with #E_TYPE_INVALID
   4BF9 7E            [ 7]  352                     ld      a, (hl)
   4BFA FE 00         [ 7]  353                     cp      #E_TYPE_INVALID    
   4BFC 28 23         [12]  354                     jr      z, man_end_while_l     
                            355 
   4BFE D5            [11]  356                     push de
   4BFF 21 01 00      [10]  357                     ld hl, #CMPs
   4C02 19            [11]  358                     add hl,de
   4C03 7E            [ 7]  359                     ld a, (hl)
   4C04 DD 6E 02      [19]  360                     ld l, 2(ix)
   4C07 DD 66 03      [19]  361                     ld h, 3(ix)
   4C0A A5            [ 4]  362                     and l
   4C0B BD            [ 4]  363                     cp  l
   4C0C 28 02         [12]  364                     jr z, man_goto_while_r
   4C0E 18 07         [12]  365                         jr man_continues_while_l
                            366               
                            367                 ;; if entity is not movable continue here
   4C10                     368                     man_goto_while_r:
   4C10 21 14 00      [10]  369                             ld      hl, #SPACE_4_ONE_ENTITY
   4C13 19            [11]  370                             add     hl, de
                            371                             
   4C14 CD 2A 4C      [17]  372                             call _man_entity_for_all_pairs_matching_while2
                            373                                
   4C17                     374             man_continues_while_l:
   4C17 D1            [10]  375                                 pop de
                            376 
   4C18 21 14 00      [10]  377                                 ld      hl, #SPACE_4_ONE_ENTITY
   4C1B 19            [11]  378                                 add     hl, de
   4C1C E5            [11]  379                                 push hl
                            380                             ;; HL<=>DE
   4C1D 5D            [ 4]  381                                 ld      e, l              
   4C1E 54            [ 4]  382                                 ld      d, h
                            383 
   4C1F 18 D3         [12]  384                                 jr      man_init_while_l
   4C21                     385     man_end_while_l:
                            386         ;; close stack
   4C21 DD 21 04 00   [14]  387             ld      ix, #4
   4C25 DD 39         [15]  388             add     ix, sp
   4C27 DD F9         [10]  389             ld      sp, ix
...
Hexadecimal [16-Bits]
                            ...
                            390     
   4C29 C9            [10]  391     ret
   4C2A                     392 _man_entity_for_all_pairs_matching_while2:
                            393     ;; save left entity in bc
   4C2A 4B            [ 4]  394     ld c, e
   4C2B 42            [ 4]  395     ld b, d
                            396     ;; save right entity in de
   4C2C 5D            [ 4]  397     ld e, l
   4C2D 54            [ 4]  398     ld d, h
                            399 
   4C2E C5            [11]  400     push bc
   4C2F D5            [11]  401     push de
                            402 
   4C30                     403     man_init_while_r:
   4C30 D1            [10]  404             pop de
   4C31 C1            [10]  405             pop bc
                            406 
   4C32 21 00 00      [10]  407             ld hl, #TYPE
   4C35 19            [11]  408             add hl, de
                            409 
   4C36 7E            [ 7]  410             ld a, (hl)
   4C37 FE 00         [ 7]  411             cp #E_TYPE_INVALID
   4C39 28 28         [12]  412             jr z, man_end_while_r
                            413 
   4C3B 21 01 00      [10]  414                 ld hl, #CMPs
   4C3E 19            [11]  415                 add hl, de
   4C3F 7E            [ 7]  416                 ld a, (hl)
                            417 
   4C40 DD 6E 02      [19]  418                 ld l, 2(ix)
   4C43 DD 66 03      [19]  419                 ld h, 3(ix)
                            420 
   4C46 C5            [11]  421                 push bc
   4C47 D5            [11]  422                 push de
                            423 
   4C48 A5            [ 4]  424                 and l
   4C49 BD            [ 4]  425                 cp l
   4C4A 20 0C         [12]  426                 jr nz, return_code_while_r
   4C4C 21 58 4C      [10]  427                     ld hl, #return_code_while_r
   4C4F E5            [11]  428                     push hl
                            429 
   4C50 DD 6E 00      [19]  430                     ld l, 0(ix)
   4C53 DD 66 01      [19]  431                     ld h, 1(ix)
   4C56 E5            [11]  432                     push hl
   4C57 C9            [10]  433                     ret
                            434 
   4C58                     435                 return_code_while_r:
   4C58 D1            [10]  436                     pop de
   4C59 C1            [10]  437                     pop bc
                            438 
   4C5A 21 14 00      [10]  439                     ld hl, #SPACE_4_ONE_ENTITY
   4C5D 19            [11]  440                     add hl, de
                            441 
   4C5E EB            [ 4]  442                     ex de, hl
                            443 
   4C5F C5            [11]  444                     push bc
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 105.
Hexadecimal [16-Bits]



   4C60 D5            [11]  445                     push de
                            446 
   4C61 18 CD         [12]  447                     jr man_init_while_r
   4C63                     448 man_end_while_r:
   4C63 C9            [10]  449 ret
                            450 
                            451 ;;;;;;;;;;;;;;;;;;;;
                            452 ;; MANAGER UPDATE ;;
                            453 ;;;;;;;;;;;;;;;;;;;;
   4C64                     454 _man_entity_update::
                            455     ;; load first position
   4C64 11 4A 4F      [10]  456         ld      de, #m_entities     
                            457 
                            458     ;; while
   4C67                     459     man_update_init_for:
                            460             ;; go to type of entity
   4C67 21 00 00      [10]  461                 ld      hl, #TYPE
   4C6A 19            [11]  462                 add     hl, de             
                            463 
                            464             ;; save in a the type and compare with #E_TYPE_INVALID
   4C6B 7E            [ 7]  465                 ld      a, (hl)
   4C6C FE 00         [ 7]  466                 cp      #E_TYPE_INVALID     
   4C6E 28 13         [12]  467                 jr      z, man_update_end_for      
                            468             ;;if is set for destruction
   4C70 E6 80         [ 7]  469                 and      #E_TYPE_DEAD
                            470             
                            471             ;; compare A with E_TYPE_DEAD
   4C72 FE 80         [ 7]  472                 cp      #E_TYPE_DEAD
   4C74 28 08         [12]  473                 jr      z, man_update_destroy_entity   
                            474 
                            475                 ;; add SPACE_4_ONE_ENTITY De <==> HL
   4C76 21 14 00      [10]  476                     ld      hl, #SPACE_4_ONE_ENTITY
   4C79 19            [11]  477                     add     hl, de
                            478 
                            479                 ;;  HL<==>DE
   4C7A 5D            [ 4]  480                     ld      e, l              
   4C7B 54            [ 4]  481                     ld      d, h
                            482 
                            483                 ;; no destroy  
   4C7C 18 03         [12]  484                     jr      man_update_not_destroy_entity
                            485             
   4C7E                     486             man_update_destroy_entity:      
   4C7E CD 2F 4B      [17]  487                 call    man_entity_destroy        
   4C81                     488             man_update_not_destroy_entity:  
   4C81 18 E4         [12]  489                 jr      man_update_init_for       
                            490 
   4C83                     491     man_update_end_for:
                            492 
   4C83 C9            [10]  493     ret
                            494 
                            495 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
   ...
   4C84                     500 _man_entity_free_space::
                            501     
   4C84 3E 01         [ 7]  502     ld      a, #TOTAL_ENTITIES
   4C86 ED 4B 61 4F   [20]  503     ld      bc, (m_reserved_entites)
   4C8A 91            [ 4]  504     sub     c
                            505 
   4C8B 6F            [ 4]  506     ld      l, a
                            507 
   4C8C C9            [10]  508     ret
