...
Hexadecimal [16-Bits]
                              ...
                              6 
                              7 
   46C7                       8     m_entities::    ;;entities
   46C7                       9         .ds #TOTAL_SPACE_4_ENTITIES
   46D8                      10     m_zero_byte_end_entities:      ;;zero-byte to signal invalid entities
   46D8                      11         .ds 1
   46D9                      12     m_next_free_entity::    ;; pointer to next free entity
   46D9                      13         .ds 2
   46DB                      14     m_reserved_entites:: ;;number of reserved entities
   46DB                      15         .ds 1   ;;u8
                             16 
                             17 .area _CODE
                             18 ;;;;;;;;;;;;;;;;;;;;;;
                             ...
                             23 ;; GENERAL INIT ;;
                             24 ;;;;;;;;;;;;;;;;;;
   421A                      25 _man_entity_init::
                             26 
                             27     ;; save the first element of entities
                             28     ;;m_next_free_entity = m_entities;
   421A 21 C7 46      [10]   29         ld      hl, #m_entities
   421D 22 D9 46      [16]   30         ld      (m_next_free_entity),  hl
                             31 
   ...
   4220 5D            [ 4]   36         ld      e, l
   4221 54            [ 4]   37         ld      d, h
   4222 3E 00         [ 7]   38         ld      a, #0
   4224 01 11 00      [10]   39         ld      bc, #TOTAL_SPACE_4_ENTITIES
   4227 CD E6 45      [17]   40         call    cpct_memset_asm
                             41     
                             42     ;; load a 0 in reserved_entities
   422A 3E 00         [ 7]   43         ld      a, #0
   422C 32 DB 46      [13]   44         ld      (m_reserved_entites), a
                             45     
                             46     ;; load invalid type in _m_zero_byte_end_entities
   422F 3E 00         [ 7]   47         ld      a, #E_TYPE_INVALID
   4231 32 D8 46      [13]   48         ld      (m_zero_byte_end_entities), a
                             49 
   4234 C9            [10]   50     ret
                             51 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                             52 
...
Hexadecimal [16-Bits]
   ...
   4235 ED 5B D9 46   [20]   60         ld      de, (m_next_free_entity)
                             61 
                             62     ;; set type on default
   4239 21 00 00      [10]   63         ld      hl, #TYPE
   423C 19            [11]   64         add     hl, de
   423D 36 02         [10]   65         ld      (hl), #E_TYPE_DEFAULT
                             66     ;; Set cmp to default
   423F 21 01 00      [10]   67         ld hl, #CMPs
   4242 19            [11]   68         add hl,de
   4243 36 7F         [10]   69         ld (hl), #E_CMP_DEFAULT
                             70 
                             71     ;; update the pointer to SPACE_4_ONE_ENTITY positons furthers (the next entity)
   4245 21 11 00      [10]   72         ld      hl, #SPACE_4_ONE_ENTITY
   4248 19            [11]   73         add     hl, de
   4249 22 D9 46      [16]   74         ld      (m_next_free_entity), hl
                             75 
                             76     ;; increase reserved entities
   424C 3A DB 46      [13]   77         ld      a, (m_reserved_entites)
   424F 3C            [ 4]   78         inc     a
   4250 32 DB 46      [13]   79         ld      (m_reserved_entites), a
                             80 
   4253 C9            [10]   81     ret
                             82 
                             83 ;;;;;;;;;;;;;;;;;;;;;;;
   ...
   4254 D5            [11]   95     push de
                             96     ;; create entity
   4255 CD 35 42      [17]   97     call _man_entity_create
                             98     ;; retrieve de entity to clone in hl
   4258 E1            [10]   99     pop hl
                            100     ;; size in bc
   4259 01 11 00      [10]  101     ld      bc, #SPACE_4_ONE_ENTITY
                            102     ;; save pinter to new entity
   425C D5            [11]  103     push de
                            104     ;; copy entity to clone in new entity
   425D CD EE 45      [17]  105     call cpct_memcpy_asm
                            106     ;; retrieve pointer to new entity
   4260 D1            [10]  107     pop de
   4261 C9            [10]  108 ret
                            109 
                            110 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
   ...
   4262                     115 _man_entity_set_for_destruction::
                            116 
                            117     ;; go to entity -> type
   4262 21 00 00      [10]  118         ld      hl, #TYPE
   4265 19            [11]  119         add     hl, de
                            120     
                            121     ;; save entity->type in a
   4266 7E            [ 7]  122         ld      a, (hl)
                            123     
                            124     ;; set entity for destruction
   4267 F6 80         [ 7]  125         or      #E_TYPE_DEAD
   4269 77            [ 7]  126         ld      (hl), a
                            127 
   426A C9            [10]  128     ret
                            129 
                            130 
   ...
   426B 2A D9 46      [16]  145         ld      hl, (m_next_free_entity)
   426E 01 11 00      [10]  146         ld      bc, #SPACE_4_ONE_ENTITY
   4271 B7            [ 4]  147         or      a
   4272 ED 42         [15]  148         sbc     hl, bc
                            149     
                            150     ;; save the last entity
   4274 E5            [11]  151         push    hl
                            152 
                            153     ;; last == de
                            154     ;;conditional to copy
   4275 B7            [ 4]  155         or      a
   4276 ED 52         [15]  156         sbc     hl, de
   4278 28 05         [12]  157         jr      z, man_if_not_copy  
                            158 
                            159     ;; retrieve and save last entity 
   427A E1            [10]  160         pop     hl
   427B E5            [11]  161         push    hl
                            162 
                            163     ;; call the function (last != de)
   427C CD EE 45      [17]  164         call    cpct_memcpy_asm
                            165     
   427F                     166     man_if_not_copy:
                            167     ;; retrieve last entity 
   427F E1            [10]  168         pop     hl
                            169 
...
Hexadecimal [16-Bits]
   ...
   4280 36 00         [10]  171         ld      (hl), #E_TYPE_INVALID
                            172 
                            173     ;; set _m_next_free_entity to last
   4282 22 D9 46      [16]  174         ld      (m_next_free_entity), hl
                            175 
                            176     ;; decrease reserved entities
   4285 3A DB 46      [13]  177         ld      a, (m_reserved_entites)
   4288 3D            [ 4]  178         dec     a
   4289 32 DB 46      [13]  179         ld      (m_reserved_entites), a
                            180 
   428C C9            [10]  181     ret
                            182 
                            183 ;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            187 ;;
   428D                     188 _man_entity_for_all::
                            189 
                            190     ;; stack opened
   428D DD 21 FE FF   [14]  191         ld      ix, #-2
   4291 DD 39         [15]  192         add     ix, sp
   4293 DD F9         [10]  193         ld      sp, ix
                            194 
                            195     ;; save the function to call
   4295 DD 71 00      [19]  196         ld      0(ix), c
   4298 DD 70 01      [19]  197         ld      1(ix), b
                            198 
                            199     ;; load first position of an entity
   429B 11 C7 46      [10]  200         ld      de, #m_entities     
   429E D5            [11]  201         push de
                            202     ;; while
   429F                     203     man_init_for:
                            204         ;; if
                            205             ;; go to type of entity
   429F 21 00 00      [10]  206                 ld      hl, #TYPE
   42A2 19            [11]  207                 add     hl, de             
                            208 
                            209             ;; save in a the type and compare with #E_TYPE_INVALID
   42A3 7E            [ 7]  210                 ld      a, (hl)
   42A4 FE 00         [ 7]  211                 cp      #E_TYPE_INVALID    
   42A6 28 16         [12]  212                 jr      z, man_end_for     
                            213 
                            214                 ; push de
                            215             ;; save returning point
   42A8 21 B4 42      [10]  216                 ld      hl, #_return_hear
   42AB E5            [11]  217                 push    hl
                            218 
                            219             ;; call function
   42AC DD 4E 00      [19]  220                 ld      c, 0(ix)
   42AF DD 46 01      [19]  221                 ld      b, 1(ix)
   42B2 C5            [11]  222                 push    bc                  
   42B3 C9            [10]  223                 ret                         
                            224 
...
Hexadecimal [16-Bits]
   ...
   42B4                     225             _return_hear:
   42B4 D1            [10]  226                     pop de
   42B5 21 11 00      [10]  227                     ld      hl, #SPACE_4_ONE_ENTITY
   42B8 19            [11]  228                     add     hl, de
                            229 
                            230                 ;; HL<=>DE
   42B9 5D            [ 4]  231                     ld      e, l              
   42BA 54            [ 4]  232                     ld      d, h
                            233 
   42BB D5            [11]  234                     push de
                            235 
   42BC 18 E1         [12]  236                     jr      man_init_for       
                            237 
   42BE                     238     man_end_for:
                            239         ;; close stack
   42BE DD 21 02 00   [14]  240             ld      ix, #2
   42C2 DD 39         [15]  241             add     ix, sp
   42C4 DD F9         [10]  242             ld      sp, ix
                            243     
   42C6 C9            [10]  244     ret
                            245 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            249 ;;
   42C7                     250     _man_entity_for_all_matching::
                            251 
                            252     ;; stack opened
   42C7 DD 21 FA FF   [14]  253         ld      ix, #-6
   42CB DD 39         [15]  254         add     ix, sp
   42CD DD F9         [10]  255         ld      sp, ix
                            256 
                            257     ;; save the function to call
   42CF DD 71 00      [19]  258         ld      0(ix), c
   42D2 DD 70 01      [19]  259         ld      1(ix), b
                            260     ;; save the condition to call function
   42D5 DD 75 02      [19]  261         ld      2(ix), l
   42D8 DD 74 03      [19]  262         ld      3(ix), h
                            263 
                            264     ;; load first position of an entity
   42DB 11 C7 46      [10]  265         ld      de, #m_entities     
   42DE D5            [11]  266         push de
                            267     ;; while
   42DF                     268     man_init_for_match:
   42DF D1            [10]  269     pop de
                            270         ;; if
                            271             ;; go to type of entity
   42E0 21 00 00      [10]  272                 ld      hl, #TYPE
   42E3 19            [11]  273                 add     hl, de             
                            274 
                            275             ;; save in a the type and compare with #E_TYPE_INVALID
   42E4 7E            [ 7]  276                 ld      a, (hl)
   42E5 FE 00         [ 7]  277                 cp      #E_TYPE_INVALID    
   42E7 28 26         [12]  278                 jr      z, man_end_for_match     
                            279 
...
Hexadecimal [16-Bits]
   ...
   42E9 D5            [11]  280                 push de
   42EA 21 01 00      [10]  281                 ld hl, #CMPs
   42ED 19            [11]  282                 add hl,de
   42EE 7E            [ 7]  283                 ld a, (hl)
   42EF DD 6E 02      [19]  284                 ld l, 2(ix)
   42F2 DD 66 03      [19]  285                 ld h, 3(ix)
   42F5 A5            [ 4]  286                 and l
   42F6 BD            [ 4]  287                 cp  l
   42F7 20 0C         [12]  288                 jr nz, _return_hear_match
                            289 
                            290             ;; save returning point
   42F9 21 05 43      [10]  291                 ld      hl, #_return_hear_match
   42FC E5            [11]  292                 push    hl
                            293 
                            294             ;; call function
   42FD DD 4E 00      [19]  295                 ld      c, 0(ix)
   4300 DD 46 01      [19]  296                 ld      b, 1(ix)
   4303 C5            [11]  297                 push    bc                  
   4304 C9            [10]  298                 ret                         
                            299             ;; if entity is not movable continue here
   4305                     300             _return_hear_match:
   4305 D1            [10]  301                     pop de
   4306 21 11 00      [10]  302                     ld      hl, #SPACE_4_ONE_ENTITY
   4309 19            [11]  303                     add     hl, de
                            304 
                            305                 ;; HL<=>DE
   430A 5D            [ 4]  306                     ld      e, l              
   430B 54            [ 4]  307                     ld      d, h
                            308 
   430C D5            [11]  309                     push de
                            310 
   430D 18 D0         [12]  311                     jr      man_init_for_match       
                            312 
   430F                     313     man_end_for_match:
                            314         ;; close stack
   430F DD 21 06 00   [14]  315             ld      ix, #6
   4313 DD 39         [15]  316             add     ix, sp
   4315 DD F9         [10]  317             ld      sp, ix
                            318     
   4317 C9            [10]  319     ret
                            320 
                            321 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
                            ...
                            325 ;;
   4318                     326     _man_entity_for_all_pairs_matching_while1::
                            327 
                            328     ;; stack opened
   4318 DD 21 FC FF   [14]  329         ld      ix, #-4
   431C DD 39         [15]  330         add     ix, sp
   431E DD F9         [10]  331         ld      sp, ix
                            332 
                            333     ;; save the function to call
   4320 DD 71 00      [19]  334         ld      0(ix), c
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 103.
Hexadecimal [16-Bits]



   4323 DD 70 01      [19]  335         ld      1(ix), b
                            336     ;; save the condition to call function
   4326 DD 75 02      [19]  337         ld      2(ix), l
   4329 DD 74 03      [19]  338         ld      3(ix), h
                            339 
                            340     ;; load first position of an entity
   432C 11 C7 46      [10]  341         ld      de, #m_entities     
   432F D5            [11]  342         push de
                            343     ;; while
   4330                     344     man_init_while_l:
   4330 D1            [10]  345             pop de
                            346             ;; if
                            347             ;; go to type of entity
   4331 21 00 00      [10]  348                     ld      hl, #TYPE
   4334 19            [11]  349                     add     hl, de             
                            350 
                            351             ;; save in a the type and compare with #E_TYPE_INVALID
   4335 7E            [ 7]  352                     ld      a, (hl)
   4336 FE 00         [ 7]  353                     cp      #E_TYPE_INVALID    
   4338 28 23         [12]  354                     jr      z, man_end_while_l     
                            355 
   433A D5            [11]  356                     push de
   433B 21 01 00      [10]  357                     ld hl, #CMPs
   433E 19            [11]  358                     add hl,de
   433F 7E            [ 7]  359                     ld a, (hl)
   4340 DD 6E 02      [19]  360                     ld l, 2(ix)
   4343 DD 66 03      [19]  361                     ld h, 3(ix)
   4346 A5            [ 4]  362                     and l
   4347 BD            [ 4]  363                     cp  l
   4348 28 02         [12]  364                     jr z, man_goto_while_r
   434A 18 07         [12]  365                         jr man_continues_while_l
                            366               
                            367                 ;; if entity is not movable continue here
   434C                     368                     man_goto_while_r:
   434C 21 11 00      [10]  369                             ld      hl, #SPACE_4_ONE_ENTITY
   434F 19            [11]  370                             add     hl, de
                            371                             
   4350 CD 66 43      [17]  372                             call _man_entity_for_all_pairs_matching_while2
                            373                                
   4353                     374             man_continues_while_l:
   4353 D1            [10]  375                                 pop de
                            376 
   4354 21 11 00      [10]  377                                 ld      hl, #SPACE_4_ONE_ENTITY
   4357 19            [11]  378                                 add     hl, de
   4358 E5            [11]  379                                 push hl
                            380                             ;; HL<=>DE
   4359 5D            [ 4]  381                                 ld      e, l              
   435A 54            [ 4]  382                                 ld      d, h
                            383 
   435B 18 D3         [12]  384                                 jr      man_init_while_l
   435D                     385     man_end_while_l:
                            386         ;; close stack
   435D DD 21 04 00   [14]  387             ld      ix, #4
   4361 DD 39         [15]  388             add     ix, sp
   4363 DD F9         [10]  389             ld      sp, ix
...
Hexadecimal [16-Bits]
                            ...
                            390     
   4365 C9            [10]  391     ret
   4366                     392 _man_entity_for_all_pairs_matching_while2:
                            393     ;; save left entity in bc
   4366 4B            [ 4]  394     ld c, e
   4367 42            [ 4]  395     ld b, d
                            396     ;; save right entity in de
   4368 5D            [ 4]  397     ld e, l
   4369 54            [ 4]  398     ld d, h
                            399 
   436A C5            [11]  400     push bc
   436B D5            [11]  401     push de
                            402 
   436C                     403     man_init_while_r:
   436C D1            [10]  404             pop de
   436D C1            [10]  405             pop bc
                            406 
   436E 21 00 00      [10]  407             ld hl, #TYPE
   4371 19            [11]  408             add hl, de
                            409 
   4372 7E            [ 7]  410             ld a, (hl)
   4373 FE 00         [ 7]  411             cp #E_TYPE_INVALID
   4375 28 28         [12]  412             jr z, man_end_while_r
                            413 
   4377 21 01 00      [10]  414                 ld hl, #CMPs
   437A 19            [11]  415                 add hl, de
   437B 7E            [ 7]  416                 ld a, (hl)
                            417 
   437C DD 6E 02      [19]  418                 ld l, 2(ix)
   437F DD 66 03      [19]  419                 ld h, 3(ix)
                            420 
   4382 C5            [11]  421                 push bc
   4383 D5            [11]  422                 push de
                            423 
   4384 A5            [ 4]  424                 and l
   4385 BD            [ 4]  425                 cp l
   4386 20 0C         [12]  426                 jr nz, return_code_while_r
   4388 21 94 43      [10]  427                     ld hl, #return_code_while_r
   438B E5            [11]  428                     push hl
                            429 
   438C DD 6E 00      [19]  430                     ld l, 0(ix)
   438F DD 66 01      [19]  431                     ld h, 1(ix)
   4392 E5            [11]  432                     push hl
   4393 C9            [10]  433                     ret
                            434 
   4394                     435                 return_code_while_r:
   4394 D1            [10]  436                     pop de
   4395 C1            [10]  437                     pop bc
                            438 
   4396 21 11 00      [10]  439                     ld hl, #SPACE_4_ONE_ENTITY
   4399 19            [11]  440                     add hl, de
                            441 
   439A EB            [ 4]  442                     ex de, hl
                            443 
   439B C5            [11]  444                     push bc
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (Zilog Z80 / Hitachi HD64180), page 105.
Hexadecimal [16-Bits]



   439C D5            [11]  445                     push de
                            446 
   439D 18 CD         [12]  447                     jr man_init_while_r
   439F                     448 man_end_while_r:
   439F C9            [10]  449 ret
                            450 
                            451 ;;;;;;;;;;;;;;;;;;;;
                            452 ;; MANAGER UPDATE ;;
                            453 ;;;;;;;;;;;;;;;;;;;;
   43A0                     454 _man_entity_update::
                            455     ;; load first position
   43A0 11 C7 46      [10]  456         ld      de, #m_entities     
                            457 
                            458     ;; while
   43A3                     459     man_update_init_for:
                            460             ;; go to type of entity
   43A3 21 00 00      [10]  461                 ld      hl, #TYPE
   43A6 19            [11]  462                 add     hl, de             
                            463 
                            464             ;; save in a the type and compare with #E_TYPE_INVALID
   43A7 7E            [ 7]  465                 ld      a, (hl)
   43A8 FE 00         [ 7]  466                 cp      #E_TYPE_INVALID     
   43AA 28 13         [12]  467                 jr      z, man_update_end_for      
                            468             ;;if is set for destruction
   43AC E6 80         [ 7]  469                 and      #E_TYPE_DEAD
                            470             
                            471             ;; compare A with E_TYPE_DEAD
   43AE FE 80         [ 7]  472                 cp      #E_TYPE_DEAD
   43B0 28 08         [12]  473                 jr      z, man_update_destroy_entity   
                            474 
                            475                 ;; add SPACE_4_ONE_ENTITY De <==> HL
   43B2 21 11 00      [10]  476                     ld      hl, #SPACE_4_ONE_ENTITY
   43B5 19            [11]  477                     add     hl, de
                            478 
                            479                 ;;  HL<==>DE
   43B6 5D            [ 4]  480                     ld      e, l              
   43B7 54            [ 4]  481                     ld      d, h
                            482 
                            483                 ;; no destroy  
   43B8 18 03         [12]  484                     jr      man_update_not_destroy_entity
                            485             
   43BA                     486             man_update_destroy_entity:      
   43BA CD 6B 42      [17]  487                 call    man_entity_destroy        
   43BD                     488             man_update_not_destroy_entity:  
   43BD 18 E4         [12]  489                 jr      man_update_init_for       
                            490 
   43BF                     491     man_update_end_for:
                            492 
   43BF C9            [10]  493     ret
                            494 
                            495 ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Hexadecimal [16-Bits]
   ...
   43C0                     500 _man_entity_free_space::
                            501     
   43C0 3E 01         [ 7]  502     ld      a, #TOTAL_ENTITIES
   43C2 ED 4B DB 46   [20]  503     ld      bc, (m_reserved_entites)
   43C6 91            [ 4]  504     sub     c
                            505 
   43C7 6F            [ 4]  506     ld      l, a
                            507 
   43C8 C9            [10]  508     ret
