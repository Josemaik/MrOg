...
Hexadecimal [16-Bits]
   ...
   444D                      18 _wait:
                             19     ;; loop
   444D                      20       wait_init_for:
                             21          ;; compare A with 0 and two halts
   444D FE 00         [ 7]   22             cp       #0                   
   444F 28 0E         [12]   23             jr       z, wait_end_for      
   4451 06 02         [ 7]   24             ld       b, #2
   4453 CD CD 45      [17]   25             call     cpct_waitHalts_asm
                             26 
                             27          ;; save a
   4456 F5            [11]   28             push     af
                             29          ;; wait sync
   4457 CD D1 45      [17]   30             call     cpct_waitVSYNC_asm
                             31          
                             32          ;; a-1
   445A F1            [10]   33             pop      af
   445B D6 01         [ 7]   34             sub      #1
                             35          ;; go loop
   445D 18 EE         [12]   36             jr       wait_init_for
                             37    ;; end for
   445F                      38       wait_end_for:
   445F C9            [10]   39    ret
                             40 ;;;;;;;;;;;;;;;;;;;;;
                             41 ;; PUBLIC FUNCTION ;;
                             42 ;;;;;;;;;;;;;;;;;;;;;
                             ...
                             45 ;;;CREATE TEMPLATE
                             46 ;;
   4460                      47 man_game_create_template_entity::
   4460 E5            [11]   48    push hl
                             49    ;; create entity
   4461 CD 35 42      [17]   50         call _man_entity_create
                             51     
                             52         ;; load entity from stack
   4464 E1            [10]   53         pop hl
   4465 D5            [11]   54         push de
   4466 01 11 00      [10]   55         ld bc,#SPACE_4_ONE_ENTITY
   4469 CD EE 45      [17]   56         call cpct_memcpy_asm
   446C D1            [10]   57         pop de
   446D C9            [10]   58    ret
                             59 
                             60 
...
Hexadecimal [16-Bits]
   ...
   446E                      61 _inicialize_templates:
   446E 21 DC 46      [10]   62         ld       hl, #playership_template0_e
   4471 CD 60 44      [17]   63         call man_game_create_template_entity
   4474 C9            [10]   64 ret
                             65 ;;;;;;;;;;;;;;;;;;;;
                             66 ;; INIT
                             67 ;;
   4475                      68 man_game_init::
                             69     ;; configure videomode, palet y border
   4475 CD 05 42      [17]   70         call     _sys_render_init
                             71 
                             72     ;; inicialize manager entity
   4478 CD 1A 42      [17]   73         call     _man_entity_init
                             74 
                             75     ;; Create mothership
   447B CD 6E 44      [17]   76        call    _inicialize_templates
   447E C9            [10]   77 ret
                             78 ;;;;;;;;;;;;;;;;;;;;;;
                             79 ;; PLAY
                             80 ;;
                             81 
   447F                      82 man_game_play::
                             83    ;; infinite loop
   447F                      84    loop:
                             85       ;; call ai manager
                             86          ; call      _sys_ai_update
                             87       ;; update positions
   447F CD 9A 41      [17]   88          call     _sys_physics_update
                             89       ;; check collisions
                             90          ; call     _sys_collision_update
                             91       ;; call animations system
                             92          ; call     _sys_animations_update
                             93       ;; render
   4482 CD FB 41      [17]   94          call     _sys_render_update
                             95       ;; update manager
   4485 CD A0 43      [17]   96          call     _man_entity_update
                             97       ;; wait ( se mueve cada cinco fotogramas)
   4488 3E 05         [ 7]   98          ld       a, #5
   448A CD 4D 44      [17]   99 		 call     _wait
                            100          ; call cpct_waitVSYNC_asm
                            101       ;; jump to loop
   448D 18 F0         [12]  102          jr       loop
   448F C9            [10]  103 ret
