...
Hexadecimal [16-Bits]
                              ...
                              8 ;;;;;;;;;;;;;;;;;;;;
                              9    ;; Entity reference                    
   4278                      10       _init_entity::                      
   4278 01                   11          .db #E_TYPE_RENDER                
   4279 4F                   12          .db #0x4f   ;79                  
   427A 01                   13          .db #0x01   ;1                   
   427B 01                   14          .db #0x01   ;1                   
   427C 80                   15          .db #0x80   ;10                  
   427D 00                   16          .db #0x00   ;00                  
   427E 00                   17          .db #0x00   ;00                  
                             18 
                             19 .area _CODE
...
Hexadecimal [16-Bits]
   ...
   401D 01 FF FF      [10]   50       ld bc, #-1
   4020 16 00         [ 7]   51       ld d, #0
                             52 
                             53    ;; init for
   4022                      54       divide_for:
                             55 
                             56          ;; subtract DE from HL (uses the a register)
   4022 ED 52         [15]   57             sbc hl, de
                             58 
                             59          ;;increment BC by 1
   4024 03            [ 6]   60             inc bc
                             61          
                             62          ;; conditional to repeat for
   4025 30 FB         [12]   63             jr nc, divide_for
                             64 
                             65    ;; take the rest into hl
   4027 19            [11]   66             add hl, de
                             67 
   4028 C9            [10]   68    ret
                             69 
                             70 
...
Hexadecimal [16-Bits]
   ...
   4029 CD 24 41      [17]   77       call     _man_entity_create    ;; returns in DE the direcction of entity
                             78 
                             79    ;; save the pointer to the entity
   402C D5            [11]   80       push     de   
                             81 
                             82     
                             ...
                             87          ;; BC -> size of data
                             88 
   402D 21 78 42      [10]   89       ld       hl, #_init_entity
   4030 01 07 00      [10]   90       ld       bc, #SPACE_4_ONE_ENTITY
   4033 CD 06 42      [17]   91       call     cpct_memcpy_asm
                             92 
                             93    ;; take a random value to put in Y -> cpct_getRandom_mxor_u8_asm
                             94       ;; OUPUT
                             95          ;; L -> random value
   4036 CD 19 42      [17]   96       call     cpct_getRandom_mxor_u8_asm
                             97 
                            ...
                            103          ;; HL -> the rest
                            104          ;; BC -> the result 
   4039 26 00         [ 7]  105       ld       h, #0
   403B 1E C8         [ 7]  106       ld       e, #200
   403D CD 1A 40      [17]  107       call     divide
                            108 
                            109    ;; save the rest in A
   4040 7D            [ 4]  110       ld       a, l
                            111 
                            112    ;; retrieve the pointer to the entity into DE
   4041 D1            [10]  113       pop      de
                            114 
                            115    ;; we add Y to DE (de+y)
   4042 21 02 00      [10]  116       ld       hl, #Y
   4045 19            [11]  117       add      hl, de
                            118 
                            119    ;; put final value in entity->y
   4046 77            [ 7]  120       ld       (hl), a
                            121 
                            122    
                            123    ;; save the pointer to the entity
   4047 D5            [11]  124       push     de
                            125    
                            126    ;; take a random value to put in VX -> cpct_getRandom_mxor_u8_asm
                            127       ;; OUPUT
                            128          ;; L -> random value
   4048 CD 19 42      [17]  129       call     cpct_getRandom_mxor_u8_asm
                            130 
...
Hexadecimal [16-Bits]
   ...
   404B 7D            [ 4]  132       ld       a, l
   404C E6 03         [ 7]  133       and      #3
                            134    
                            135    ;; make it between 1 and 4
   404E C6 01         [ 7]  136       add      a, #1
                            137    
                            138    ;; retrieve the pointer to the entity into DE
   4050 D1            [10]  139       pop      de
                            140 
                            141    ;; we add Y to DE (de+y)
   4051 21 05 00      [10]  142       ld       hl, #VX
   4054 19            [11]  143       add      hl, de
                            144 
                            145    ;; put final value in entity->vx
   4055 77            [ 7]  146       ld       (hl), a
                            147 
   ...
   4056 C9            [10]  168    ret
                            ...
                            170 
                            171 
   4057                     172 _sys_generator_update::
                            173 
                            174     ;; know if free space -> _man_entity_free_space
                            175         ;; OUTPUTS;;
                            176    ;          ;; L -> num of free entities
   4057 CD BF 41      [17]  177       call    _man_entity_free_space
                            178 
                            179       ; ld a , l
...
Hexadecimal [16-Bits]
                            ...
                            196       ; while_end:
                            197    ;  ;; check if L is 0
   405A 7D            [ 4]  198         ld      a, l
   405B FE 00         [ 7]  199         cp      #0
   405D 28 05         [12]  200         jr      z, sys_no_generate_star   ;; it was 0
                            201 
   405F 18 00         [12]  202         jr      sys_generate_star
                            203 
                            204     
   4061                     205     sys_generate_star:
                            206    ;  ;; genrate new star -> generate_new_start
   4061 CD 29 40      [17]  207         call    generate_new_start
                            208 
   4064                     209     sys_no_generate_star:
                            210        
   4064 C9            [10]  211     ret
